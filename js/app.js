  ...
  function isDrawableUnique(stationID, lineID) {
    for(const line of net.lines){
      for(const station of line.stations){
        if(station.xPos == net.lines[lineID].stations[stationID].xPos && station.yPos == net.lines[lineID].stations[stationID].yPos && station.yPos == net.lines[lineID].stations[stationID].yPos && net.lines.indexOf(line) != lineID){
          return false;
        }
      }
    }
