  ...
  function isUniqueInLine(lineID) {
    ...
    for(const element of net.lines[lineID].stations){
      ...
      if(element != undefined){
        ...
        if(mosX >= element.xPos-10 && mosY >= element.yPos-element.height/3 && mosX <= element.xPos+10 && mosY <= element.yPos+element.height/3){
  ...
  function isDrawableUnique(stationID, lineID) {
    ...
    for(const line of net.lines){
      ...
      for(const station of line.stations){
        ...
        if(station.xPos-10 <= net.lines[lineID].stations[stationID].xPos && station.yPos-station.height/3 <= net.lines[lineID].stations[stationID].yPos && station.xPos+10 >= net.lines[lineID].stations[stationID].xPos && station.yPos+station.height/3 >= net.lines[lineID].stations[stationID].yPos && net.lines.indexOf(line) != lineID){
